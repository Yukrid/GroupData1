...
namespace gd{
    ...
    template <size_t S, typename T>
    ConstRange<T> Array<S, T>::crange(const size_t& e_) const noexcept
    { 
    ...
    template <size_t S, typename T>
    ConstRange<T> Array<S, T>::crange(const size_t& b_, const size_t& e_) const noexcept
    { 
    ...
    template <size_t S, typename T>
    ConstRange<T> ElasticArray<S, T>::crange(const size_t& e_) const noexcept
    { 
        return ConstRange<T>{_elements, _elements+e_};
    }
    ...
    template <size_t S, typename T>
    ConstRange<T> ElasticArray<S, T>::crange(const size_t& b_, const size_t& e_) const noexcept
    { 
        return ConstRange<T>{_elements+b_, _elements+e_};
    }
