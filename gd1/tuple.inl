...
namespace gd{
    ...
    template <typename T, typename... As>
    template <uint16_t R>
    const auto& Tuple<T, As...>::ref(void) const noexcept
    {
        return _ref(Rank<R>{ });
    }
    ...
    template <typename T, typename... As>
    template <uint16_t R>
    const auto& Tuple<T, As...>::_ref(Rank<R>) const noexcept
    {
        return tuples._ref(Rank<R-1>{ });
    }
    
    
    
    template <typename T, typename... As>
    const T& Tuple<T, As...>::_ref(Rank<0>) const noexcept
    {
        return element;
    }
    ...
    template <typename T, typename... As>
    const Tuple<T, As...>* Tuple<T, As...>::spec(void) const noexcept
    {
        return this;
    }
    ...
    {
        tp_.template path<N>()=this->ref<N>();
    ...
    {
        tp_.template path<0>()=this->ref<0>();
    ...
    template <typename T, typename... As>
    template <uint16_t R>
    const auto& ElasticTuple<T, As...>::ref(void) const noexcept
    {
        return _ref(Rank<R>{ });
    }
    ...
    template <typename T, typename... As>
    template <uint16_t R>
    const auto& ElasticTuple<T, As...>::_ref(Rank<R>) const noexcept
    {
        return tuples._ref(Rank<R-1>{ });
    }
    ...
    template <typename T, typename... As>
    const T& ElasticTuple<T, As...>::_ref(Rank<0>) const noexcept
    {
        return element;
    }
    ...
    template <typename T, typename... As>
    const ElasticTuple<T, As...>* ElasticTuple<T, As...>::spec(void) const noexcept
    {
        return this;
    }
