...
namespace gd{
    ...
    auto View<T>::ref(void) const noexcept -> typename std::enable_if_t<(N==0), const T*>
    {
        return _elements;
    }
    ...
    template <typename T>
    const T* View<T>::ref(uint16_t) const noexcept
    {
        return _elements;
    }
    ...
    template <typename T>
    const T* View<T>::spec(void) const noexcept
    { 
        return _elements;
    }
    ...
    // Reference functions
    template <typename T> template<uint16_t N>
    auto ElasticView<T>::ref(void) const noexcept -> typename std::enable_if_t<(N==0), const T*>
    {
        return _elements;
    }
    ...
    template <typename T>
    const T* ElasticView<T>::ref(uint16_t) const noexcept
    {
        return _elements;
    }
    ...
    template <typename T>
    const T* ElasticView<T>::spec(void) const noexcept
    { 
        return _elements;
    }
