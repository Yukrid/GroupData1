...
namespace gd{
    ...
    template <uint16_t D>
    ConstRange<char> Tag<D>::crange(uint16_t e_) const noexcept
    {
        return ConstRange<char>{_elements, _elements+e_};
    }
  
        
    template <uint16_t D>
    ConstRange<char> Tag<D>::crange(uint16_t b_, uint16_t e_) const noexcept
    {
        return ConstRange<char>{_elements+b_, _elements+e_};
    }
