...
namespace gd{
    ...
    struct Table{
        ...
        // Access Functions
        public :
        void _operator_equal (const Table<As...>&) const noexcept;
        void _operator_equal (Table<As...>&&)      const noexcept;
    ...
    struct Table<T, As...>{
        ...
        const View<T> _ref                  (Rank<0>)                const noexcept;
        template <uint16_t N>
        ...
        #endif
        Table<T, As...>& _operator_equal    (const Table<T, As...>&) noexcept;
        Table<T, As...>& _operator_equal    (Table<T, As...>&&)      noexcept;
    ...
    struct ElasticTable<T, As...>{
        ...
        template <uint16_t N>
        const auto           _ref                  (Rank<N>)                const noexcept;
        const ElasticView<T> _ref                  (Rank<0>)                const noexcept;
        template <uint16_t N>
              auto           _spec                 (Rank<N>)                const noexcept -> Tuple<const T*, const As*...>;
              auto           _spec                 (Rank<1>)                const noexcept -> Tuple<const T*>;
              auto            spec                 (void)                   const noexcept -> decltype(_spec(std::declval<Rank<sizeof...(As)+1>>()));
