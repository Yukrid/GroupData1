...
namespace gd{
    ...
    struct List{
        ...
        #endif
              ConstRange<T> crange     (void)                         const noexcept;
              ConstRange<T> crange     (const size_t&)                const noexcept;
              ConstRange<T> crange     (const size_t&, const size_t&) const noexcept;
